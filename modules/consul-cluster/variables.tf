...
variable "source_image" {
  description = "The source image (name, not family) used to create the boot disk for a Consul Server node. Only images based on Ubuntu 16.04 or 18.04 LTS are supported at this time."
  type        = string
}
...
variable "instance_group_update_policy" {
  type        = any
  description = "See https://www.terraform.io/docs/providers/google/r/compute_region_instance_group_manager.html#update_policy"
  default     = null
}
